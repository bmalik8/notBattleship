/**
 * Represents a Gameboard for your computer opponent in the game of Battleship.
 */
//Allison
public class GameboardOpponent
{
    ...
    /**
     * Initializes gameboard with 10x10 empty BoardSpot objects.
     */
    ...
    /**
     * Places ships (no overlaps) in random spots on the board.
     */
    ...
    /**
     * Checks whether a ship has been sunk, and checks whether all ships are sunk.
     */
    public static void shipSunk(Ship ship)
    {
        ...
        if (ship.getIsSunken())
        {
            ...
            System.out.println("Number of ships sunk: "+shipsSunken);
        }   
        //check if you win
        if (shipsSunken==5)
        {
